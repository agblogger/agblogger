import {
  ...
  Quote, Code, SquareCode,
  Radical, SquareFunction,
...
const items: readonly ToolbarItem[] = [
  ...
  { separator: true },
  { key: 'blockquote', label: 'Blockquote', Icon: Quote, shortcut: `${mod}+Shift+.` },
  { key: 'code', label: 'Code', Icon: Code, shortcut: `${mod}+E` },
  { key: 'codeblock', label: 'Code Block', Icon: SquareCode, shortcut: `${mod}+Shift+E` },
  { key: 'math', label: 'Math', Icon: Radical },
  { key: 'mathblock', label: 'Math Block', Icon: SquareFunction },
  { separator: true },
